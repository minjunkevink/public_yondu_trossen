...
def main() -> None:
    ...
    dset_path = f"azureml://subscriptions/{subscription_id}/resourcegroups/{resource_group}/workspaces/{workspace_name}/datastores/workspaceblobstore/paths/datasets/lr_dsets/new_yondu_teleop_data_head_only_rgb_and_dep"

    out_dir = f"azureml://subscriptions/{subscription_id}/resourcegroups/{resource_group}/workspaces/{workspace_name}/datastores/workspaceblobstore/paths/models/ddp_testing/saves/r1_lr_mainn_{dt_str}"
    inputs = {
        "dset_path": Input(
    ...
    --config_path=examples/configs/az_train.yaml
    --dataset.root=${{inputs.dset_path}}
    ...
    job = command(
        description="train lerobot main branch",
