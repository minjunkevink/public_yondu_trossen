...
def main() -> None:
    ...
    dset_path = f"azureml://subscriptions/{subscription_id}/resourcegroups/{resource_group}/workspaces/{workspace_name}/datastores/workspaceblobstore/paths/datasets/remote_lr_dsets_pi0"

    out_dir = f"azureml://subscriptions/{subscription_id}/resourcegroups/{resource_group}/workspaces/{workspace_name}/datastores/workspaceblobstore/paths/models/ddp_testing/saves/r1_lr_mainnremote_{dt_str}"
    inputs = {
        # "dset_path": Input(
    ...
    --config_path=examples/configs/az_train_remote.yaml
    --dataset.root=${{outputs.dset_path}}
